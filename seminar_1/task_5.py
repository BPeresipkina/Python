...
j = int(input('Введите номер, который написан в вагоне: '))

if i!=j:
    print(f'В поезде {int(j+i-1)} вагонов')

else:
    print(f'Информации недостаточно для точного определения кол-ва вагонов')
